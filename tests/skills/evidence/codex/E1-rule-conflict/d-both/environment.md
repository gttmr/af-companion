...
- date: 2026-07-31
- experiment: E1 (rule conflict adjudication), condition `d-both`
...
- cwd for the run: `/tmp/claude-1000/-home-ilmaswsl-work-adk-apps/be23ad91-f1a7-4e71-a593-54ed74ca24cf/scratchpad/E1/d-both` (fresh empty dir, one per condition)
