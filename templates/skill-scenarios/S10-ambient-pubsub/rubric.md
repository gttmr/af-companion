- strict v2 analysis/candidates/Graph, approved runtime contract, Work Item, boundary design과 scaffold plan의 parity를 확인한다.
...
- `can_generate_source: false`와 Scaffold `blocked`를 그대로 적용하고 명시적 blocker와 unblock 조건을 보고한다.
