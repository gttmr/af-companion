...
- strict Target Contract v2 analysis, split artifacts, reviewed boundary, scaffold plan과 Work Item을 predecessor gate로 검증한다.
...
- `can_generate_source: false`, Scaffold `blocked`, Scaffold Readiness `Not Ready`를 존중해 source, runtime stub, test 또는 implementation handoff를 생성하지 않는다.
