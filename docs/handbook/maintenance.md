...
1. 변경된 Source Code가 어느 Work Skill 또는 live companion surface에 속하는지 확인한다.
...
4. 실제 행동이 달라졌다면 해당 Work Skill/projection의 목적, 입력·출력, Main Flow, 분기와 실패 설명을 갱신한다.
5. Route/API 수, Register 연결, locator status가 맞도록 [Index](index.md)와 [Coverage](coverage.md)를 갱신한다.
