...
| `/connections` | Hook bridge, session roles, Plan handoffs, explicit attach, and deliveries | `packages/web/src/routes/ConnectionsPage.tsx` |
...
| `/api/codex-companion` | GET snapshot; POST preferences/handoff/attach/queue/cancel/VS Code launch | `packages/web/server/codexCompanionApi.ts` |
