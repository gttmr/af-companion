...
- Agent·Workflow·Tool 정의는 `taxonomy.md`, Node·Edge와 Invocation Control은 `graph-ir.md`, Work Skill과 review gate는 `operating-model.md`에 링크한다. 보조 문서에서 이를 다시 정의하지 않는다.
