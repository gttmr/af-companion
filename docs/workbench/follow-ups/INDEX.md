...
새 후속은 네 Work Skill, `af-work-item.json`, external Codex Hook, read-only workspace projection, Graph-only web edit 경계 중 어느 계약에 속하는지 먼저 정한 뒤 해당 canonical 문서에 기록한다.
