...
| ID | 상태 | 범위 |
| --- | --- | --- |
| [18](./18-agents-cli-1-1-skill-adoption.md) | planned | agents-cli 1.1.0의 design dialogue, scope control, locator 교정, container/Gateway 인식을 네 Work Skill과 별도 ADK app workspace 설계에 선택적으로 도입 |
...
- ADK Runtime Handoff와 generator는 ADK 2.3 계약을 유지한다.
